...
|                                          |                    |          |            db             |
|                             Sonar        |                    |          +---------------------------+
|                                          | pitch/plugin       |          |UI/animation               |responsive 响应快
|      report                 monkey       | module/Component   |APKProtect|Thread/coroutine           |throughput 高吞吐 threadtime/(threadtime+othertime)
|PR   wireshark     CheckStyle/FindBugs/PMD|    OOAD            |          |memory/file(image)/DB/Net  |Cache //gc 低延时 latency，频繁，空间换时间
|typo   Timber    Lint     jdwp/jdb/gdb    |                    |proguard  |  /Storage                 |
|       Log     (wanning)   (Exception)    |DRY/KISS/SOLID/CARP |hash      |DSA/jni                    |alth Speed
+------------------------------------------------------------------------------------------------------+
