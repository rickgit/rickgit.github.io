...
|             db                 |     kernel (POSIX)                                                  |
+------------------------------------------------------------------------------------------------------+
|    Review(Lint,PullRequest/security/OOAD/DSA/Cache/file/DB/Net)                                      |
|    jdwp/jdb gdb,CheckStyle FindBugs PMD,                                                             |
+------------------------------------------------------------------------------------------------------+
|                                  code refactoring                                                    |
+------------------------------------------------------------------------------------------------------+
|                       Apache(commons-cli )                                                           |
+-----------------------------------------------------------------------+------------------------------+
|                  |  Spring boot                                       |                              |
|                  |  AutoTools(gnu make), Cmake ,Ninja,SCons,jenkins   |JaCoCo/Cobertura              |
|  vss             |  cruisecontrol,dagger asm/CGLIB                    |Junit,mockito/ EasyMock,Gtest,|
...
+------------------------------------------------------------------------------------------------------+
|                       GNU C (glibc) ,gnu sed,OpenJDK(gc),pythonc                                     |
+-----------+------------------------------------------------------------------------------------------+
