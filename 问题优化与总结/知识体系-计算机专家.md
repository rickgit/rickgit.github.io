...
|                       Apache(commons-cli )                                                           |
+------------------------------------------+-----------------+-------------+---------------------------+
|      report                 monkey       | pitch/plugin    |             |                           |
|PR   wireshark     CheckStyle/FindBugs/PMD|    OOAD         |             |   Thread/coroutine        |
|typo   Timber    Lint     jdwp/jdb/gdb    |    SOLID/CARP   | proguard    |   Cache/file/DB/Net       |
|       Log     (wanning)   (Exception)    | DRY/KISS        | hash        |   DSA                     |
+------------------------------------------------------------------------------------------------------+
|                 detect bug               |  cohesion       | security    |    Effective              |
+------------------------------------------+-----------------+-------------+---------------------------+
|                                   review(refactoring )                                               |
+------------------------------------------------------------------------------------------------------+
