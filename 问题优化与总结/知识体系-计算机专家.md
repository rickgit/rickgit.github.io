...
|                                          |                    |          +---------------------------+
|                                          | pitch/plugin       |          |                           |
|      report                 monkey       | module/Component   |          |UI                         |responsiveness
|PR   wireshark     CheckStyle/FindBugs/PMD|    OOAD            |          |Thread/coroutine           |throughput
|typo   Timber    Lint     jdwp/jdb/gdb    |                    |proguard  |Cache/file/DB/Net/Storage  |//空间换时间
|       Log     (wanning)   (Exception)    |DRY/KISS/SOLID/CARP |hash      |DSA                        |Speed
+------------------------------------------------------------------------------------------------------+
|                 detect bug               |cohesion/Scalability|security  |  Time Performance         |
+--------------------------------------------------------------------------+---------------------------+
...
+------------------------------------------------------------------------------------------------------+
|  version control |      Pragmatic Project Automation                  | unit test                    |Effective,Efficiency,Stability
+------------------------------------------------------------------------------------------------------+
