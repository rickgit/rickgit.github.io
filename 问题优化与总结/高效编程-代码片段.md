...
```
### WebView 需要设置js,cache参数
```
private fun initCache(settings: WebSettings, cache:String,dbpath:String) {
...
object : WebChromeClient() {//两个方法同时重写，不能放空，没有实现。这样会导致游戏界面空白
