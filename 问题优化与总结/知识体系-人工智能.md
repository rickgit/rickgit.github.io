...
+----------------------+-------------------------------------------------------------+
|                                                                                    |
| Machine    supervised learning (Classified and regression)                         |
| learning                                                                           |
| classification                                                                     |
...
+------------------------------------------------------------------------------------+
|                                                                                    |
| Machine    linear model     logistic regression       clustering                   |
| Learning                                                                           |
| Algorithm  decision tree    SVM                                                    |
|                                                                                    |
|            Bias analyzer    ANN(Deep learning MLP/CNN/RNN-LSTM/GAN)                |
|                      +-------------------------------------------------------------+
