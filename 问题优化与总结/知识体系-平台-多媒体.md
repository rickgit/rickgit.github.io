...
图表：走势图，圆盘刻度
绘制 几何，路径，文本，图片，音视频；
View 白板：绘制 点，线，弧，圆，路径，文本，位图；
     画笔：
         1. setARGB，Shader着色器（位图，渐变，。。。），setShadowLayer阴影，，颜色过滤器
            ...
            setMaskFilter（BlurMaskFilter模糊，EmbossMaskFilter浮雕）遮罩阴影；
...
### 音视频采集（声卡 AudioRecord，摄像头 Camera，音视频MediaRecorder）
AudioRecord
