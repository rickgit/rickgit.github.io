...
+---------------------------+-----------------------------------------+
|      Structure of JVM     |              Run-Time Data Areas        |
+-----------+---------------------------------------------------------+
|           | Initialization|                                         |
|           +------------------------------+--------------------------+
|           |               | Resolution   |                          |
|Continuity |               +--------------+                          |
|Complete   | linking       | Preparation  |                          |
|           |               +--------------+                          |
|           |               | Verification |                          |
|           +---------------------------------------------------------+
...
2. 类加载器与双亲委派模型(Parents Dlegation Mode)
```
                 C++
 +-----------------------+
